...
<head>
    ...
    <!--====== Title ======-->
    <title>Vic Andam | Get A Free Consultation</title>
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="#">
                            <img src="assets/images/logo-2.svg" alt="smart-logo">
                            <img src="assets/images/vic-3.png" alt="Logo">
                        </a>
        ...
        <div class="bd-example">
            <div id="carouselOne" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item bg_cover active" style="background-image: url({{ asset('assets/images/slider-2.jpg') }})">
                        <div class="carousel-caption">
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="row justify-content-center mb-5">
                                        <h2 class="carousel-title">I help real estate investors generate high quality leads through conversion-focused websites and paid ads.</h2>
                                        <ul class="carousel-btn rounded-buttons">
                                            <li><a class="main-btn rounded-one" style="border-radius: unset; line-height: 60px" href="#contact">BOOK A CALL NOW</a></li>
                    ...
                    {{--                    <div class="carousel-item bg_cover" style="background-image: url({{ asset('assets/images/slider-2.jpg') }})">--}}
                    {{--                        <div class="carousel-caption">--}}
                    {{--                            <div class="container">--}}
                    {{--                                <div class="row justify-content-center">--}}
                    ...
                    {{--                    <div class="carousel-item bg_cover" style="background-image: url({{ asset('assets/images/slider-3.jpg') }})">--}}
                    {{--                        <div class="carousel-caption">--}}
                    {{--                            <div class="container">--}}
                    {{--                                <div class="row justify-content-center">--}}
                    {{--                                    <div class="col-xl-6 col-lg-7 col-sm-10">--}}
...
<div class="sidebar-right">
    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-social d-flex align-items-center justify-content-center">
            <span>FOLLOW US</span>
            <ul>
                <li><a href="https://twitter.com/vic67122015"><i class="lni-twitter-original"></i></a></li>
                <li><a href="https://www.facebook.com/vic.andam.522"><i class="lni-facebook-filled"></i></a></li>
            </ul>
        </div> <!-- sidebar social -->
    </div> <!-- content -->
</div>
...
{{--            <div class="col-xl-6 col-lg-8">--}}
            <div class="col-md-6">
                <div class="about-image text-center wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="100">
                    <img src="assets/images/profit.png" alt="services">
                </div>
            </div>
            <div class="col-md-6">
                <div class="section-title text-center mt-30 pb-40" style="margin-top: 186px;">
                    <h4 class="title wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.6s">Proven strategy that increase your revenue.</h4>
                    <p class="text wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">Generate more leads to your real estate business.
                        <a href="#contact">Book a call for free consultation.</a>
                    </p>
                </div> <!-- section title -->
            </div>
{{--            </div>--}}
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.2s">
                    ...
                    <div class="about-content media-body">
                        <h4 class="about-title">Conversion-focused landing page</h4>
                        <p class="text">
                            We will structure your conversion-focused landing page to attract and capture potential client's details.
            ...
            <div class="col-lg-6">
                <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.4s">
                    ...
                    <div class="about-content media-body">
                        <h4 class="about-title">Lead Management</h4>
                        <p class="text">
                            We'll create a backend system for you to easilly manage your leads like sending email follow-up and more.
                        </p>
                    </div>
                </div> <!-- single about -->
            </div>
            <div class="col-lg-6">
                <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.6s">
                    ...
                    <div class="about-content media-body">
                        <h4 class="about-title">Automated Lead Magnet</h4>
                        <p class="text">
                            We'll create a scheduling system that will send email based on your chosen schedule plus email notification to let you know every time a potential client made a successfull registration.
                        </p>
                    </div>
                </div> <!-- single about -->
            </div>
            <div class="col-lg-6">
                <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.8s">
                    ...
                    <div class="about-content media-body">
                        <h4 class="about-title">Targeted Ad Campaign</h4>
                        <p class="text">
                            We'll target specific audience to ensure getting highly qualified leads filled to your funnel. In this way we'll assured pouring your list with high conversion
...
<section id="portfolio" class="portfolio-area" style="display: none">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
...
<section id="process" class="pricing-area">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section-title text-center pb-20">
                    <h3 class="title">This is how it works</h3>
                    <p class="text">This is how we work together and achieved the results you want on your business!</p>
                </div> <!-- section title -->
            </div>
        </div> <!-- row -->
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-7 col-sm-9">
                <div class="pricing-style-one mt-40 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.2s">
                    ...
                    <div class="pricing-header text-center">
                        <h5 class="sub-title">Book a call for free consultation</h5>
                        {{--                        <p class="month"><span class="price">$ 199</span>/month</p>--}}
                    </div>
                    <div class="pricing-list">
                        <ul>
                            {{--                            <li><i class="lni-check-mark-circle"></i> Carefully crafted components</li>--}}
                            We will plan a disclosure call where we will explain your needs. I will plunge profound into the present struggles that you have in lead generation.
                        </ul>
                    </div>
                    <div class="pricing-btn rounded-buttons text-center hidden" style="display: none">
            ...
            <div class="col-lg-4 col-md-7 col-sm-9">
                <div class="pricing-style-one mt-40 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                    ...
                    <div class="pricing-header text-center">
                        <h5 class="sub-title">Strategize Detailed Action Plan</h5>
                    </div>
                    <div class="pricing-list">
                        <ul>
                            {{--                            <li><i class="lni-check-mark-circle"></i> Carefully crafted components</li>--}}
                            After the call, I will survey the circumstance that you have, and the objectives that you might want to achieve.
                            At that point, I will do my examination to detail a strong activity plan based on your needs that you can actualize immediately for free.
                        </ul>
                    </div>
                    <div class="pricing-btn rounded-buttons text-center hidden" style="display: none">
                        <a class="main-btn rounded-three" href="#">GET STARTED</a>
            ...
            <div class="col-lg-4 col-md-7 col-sm-9">
                <div class="pricing-style-one mt-40 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.8s">
                    ...
                    <div class="pricing-header text-center">
                        <h5 class="sub-title">Book Your Lead Generation System Project</h5>
                    </div>
                    <div class="pricing-list">
                        <ul>
                            {{--                            <li><i class="lni-check-mark-circle"></i> Carefully crafted components</li>--}}
                            In the event that the itemized activity plan advances to you, you can verify and book your undertaking immediately by settling the forthright installment required to begin the task.
                            After the installment has been made, we will immediately create a project repository on our project management tool to keep track the project's progress and milestone.
                        </ul>
                    </div>
                    <div class="pricing-btn rounded-buttons text-center hidden" style="display: none">
                        <a class="main-btn rounded-three" href="#">GET STARTED</a>
...
<section id="testimonial" class="testimonial-area" style="display: none">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section-title text-center pb-20">
...
<section id="client" class="client-logo-area" style="display: none">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="contact-two mt-50 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.2s">
                    ...
                    <p class="text">Let's discuss about your project in detail and will share with you our strategy to make your business grow in a projected time frame.</p>
                    <ul class="contact-info">
                        <li><i class="lni-money-location"></i> Cagayan de oro, Philippines</li>
                        <li><i class="lni-phone-handset"></i> +63-916-1010-994</li>
                        <li><i class="lni-envelope"></i> vicajobs@gmail.com</li>
                    </ul>
                </div> <!-- contact two -->
            </div>
            <div class="col-lg-6">
            ...
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <div class="copyright text-center text-lg-left mt-10">
                        <p class="text" style="font-size: 13px!important;"><span>2020 © Vic Andam</span> | Crafted by <a style="color: #38f9d7" rel="nofollow" href="https://uideck.con">UIdeck</a> and UI Elements from <a style="color: #38f9d7" rel="nofollow" href="https://ayroui.com">Ayro UI</a></p>
                    </div> <!--  copyright -->
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-5">
                    <ul class="social text-center text-lg-right mt-10">
                        <li><a href="https://www.facebook.com/vic.andam.522"><i class="lni-facebook-filled"></i></a></li>
                        <li><a href="https://twitter.com/vic67122015"><i class="lni-twitter-original"></i></a></li>
                        <li><a href="https://www.instagram.com/vicajobs/"><i class="lni-instagram-original"></i></a></li>
                        <li><a href="https://www.linkedin.com/in/vic-andam-678753b8/"><i class="lni-linkedin-original"></i></a></li>
                    </ul> <!-- social -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
